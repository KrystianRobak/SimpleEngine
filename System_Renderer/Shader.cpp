...
{
    std::ifstream FileToChange(mFragmentPath);

    if (!FileToChange.is_open())
    {
        std::cerr << "Error opening file: " << mFragmentPath << std::endl;
        return;
    }
    ...
    std::ofstream FileToWrite(mFragmentPath, std::ios::trunc);

    if (!FileToWrite.is_open())
    {
        std::cerr << "Error opening file for writing: " << mFragmentPath << std::endl;
        return;
    }
